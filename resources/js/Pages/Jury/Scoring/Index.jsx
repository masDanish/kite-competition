    ...
    return (
        <JuryLayout header="Penilaian Juri">
            ...
            <motion.div
                ...
                {/* Orb */}
                <motion.div className="absolute w-48 h-48 sm:w-64 sm:h-64 rounded-full pointer-events-none"
                    style={{ background: 'radial-gradient(circle, #2dd4bf 0%, transparent 70%)', top: '-20%', right: '-5%', opacity: 0.18 }}
                    animate={{ scale: [1, 1.4, 1] }}
                    transition={{ duration: 7, repeat: Infinity, ease: 'easeInOut' }} />

                {/* Particles — hidden on very small screens for perf */}
                ...
                <div className="relative z-10 flex flex-col xs:flex-row justify-between items-start xs:items-center gap-4">
                    ...
                    <div className="relative flex items-center justify-between gap-3">
                        <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                            ...
                            <div className="min-w-0">
                                <h2 className="font-black text-white text-sm sm:text-base">Event Penugasan</h2>
                                <p className="text-teal-200 text-[10px] sm:text-xs truncate">
                                    Klik tombol Nilai untuk masuk ke halaman penilaian
                                </p>
                            </div>
                        </div>
                        ...
                        <motion.span
                            ...
                            className="inline-flex items-center gap-1.5 bg-white/20 border border-white/30
                                       text-white text-xs font-bold px-2.5 sm:px-3 py-1.5 rounded-full
                                       backdrop-blur-sm shrink-0 whitespace-nowrap">
            ...
            <motion.div
                ...
                <div className="p-4 sm:p-5">
                    ...
                    <div className="flex justify-between items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                            ...
                            <AnimatePresence>
                                {hovered && (
                                    <motion.span
                                        ...
                                        className="inline-block text-base sm:text-lg mb-1">
                                        ✨
                                    </motion.span>
                                )}
                            </AnimatePresence>
                        ...
                        <motion.div whileHover={{ scale: 1.06, y: -1 }} whileTap={{ scale: 0.96 }} className="shrink-0">
                            <Link
