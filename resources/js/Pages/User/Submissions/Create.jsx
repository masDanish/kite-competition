        ...
        <UserLayout header="Upload Karya">
            ...
            <motion.div
                ...
                className="relative overflow-hidden rounded-3xl bg-gradient-to-br
                           from-violet-600 via-indigo-600 to-blue-600 p-6 mb-8 text-white">
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-0 right-0 w-56 h-56 bg-white/10 rounded-full
                                    translate-x-1/3 -translate-y-1/3" />
                    <div className="absolute bottom-0 left-0 w-36 h-36 bg-white/5 rounded-full
                ...
                <div className="relative z-10 flex justify-between items-center">
                    <div>
                        ...
                        <h1 className="text-2xl font-black">Upload Karya Layangan 🪁</h1>
                        <p className="text-indigo-100 text-sm mt-1">
                            {registration.event.title}
                            <span className="mx-2 opacity-50">•</span>
                            Kategori: <strong>{registration.category.name}</strong>
                        </p>
                    </div>
                    <motion.div
                            ...
                            {[
                                ...
                                <li key={i} className="flex items-start gap-2 text-xs text-amber-700">
                                    <span className="w-4 h-4 bg-amber-200 rounded-full flex items-center
                                                     justify-center text-amber-700 font-bold shrink-0 mt-0.5
                                                     text-[10px]">
                                        {i + 1}
                                    </span>
                                    {tip}
                    ...
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <textarea className={inputClass} rows={4} value={data.description}
                                    ...
                                    placeholder="Ceritakan konsep, inspirasi, dan keunikan desain layangan kamu..." />
                        ...
                        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 space-y-5">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                                    File Desain
                                    <span className="text-gray-400 font-normal ml-1">(PDF/JPG/PNG, maks. 5MB)</span>
                                </label>
                                ...
                                <AnimatePresence>
                                    {errors.design_file && (
                                        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                                            className="text-red-500 text-xs mt-1.5 flex items-center gap-1">
                                            <AlertCircle className="w-3 h-3" /> {errors.design_file}
                                        </motion.p>
                                    )}
                                </AnimatePresence>
                            </div>
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                                    <span className="flex items-center gap-1.5">
                                        ...
                                        Link Video
                                        <span className="text-gray-400 font-normal">(YouTube/GDrive, opsional)</span>
                                    </span>
                                </label>
