            ...
            <motion.div initial={{opacity:0,y:-20}} animate={{opacity:1,y:0}}
                ...
                <div className="relative z-10 flex justify-between items-center gap-5">
                    ...
                    <motion.div animate={{rotate:[0,8,-4,0],y:[0,-10,0]}}
                        ...
                        className="hidden sm:block text-6xl shrink-0">🏆</motion.div>
                </div>
            </motion.div>
                ...
                <div className="flex items-start gap-5">
                    ...
                    <div className="shrink-0">
                        {medal ? (
                            ...
                            <div className="w-16 h-16 bg-gradient-to-br from-slate-100 to-gray-200
                                             rounded-2xl flex flex-col items-center justify-center
                                             border border-gray-200">
                                <span className="text-xl font-black text-gray-600">#{rank}</span>
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {result.submission ? (
                            ...
                            <div className="mt-3 flex items-center gap-2 text-sm text-gray-400
                                            bg-gray-50 rounded-2xl p-3 border border-gray-100">
