        ...
        <GuestLayout>
            ...
            <div className="min-h-screen flex items-center justify-center
                ...
                <motion.div className="absolute w-80 h-80 rounded-full pointer-events-none"
                    style={{ background: 'radial-gradient(circle, #6366f1 0%, transparent 70%)', bottom: '10%', right: '5%', opacity: 0.15 }}
                    ...
                    <div className="p-8 bg-white/5 backdrop-blur-sm">
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            {[
                                ...
                                { id: 'password', label: 'New Password', type: 'password', key: 'password', autoComplete: 'new-password' },
                            ].map(field => (
                                <div key={field.id}>
