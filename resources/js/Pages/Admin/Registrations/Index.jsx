...
const inputClass =
    "border border-gray-200 rounded-2xl px-4 py-2.5 text-sm bg-white w-full " +
    ...
    return (
        <AdminLayout header="Manajemen Pendaftaran">
            ...
            <motion.div
                ...
                <div className="relative z-10 flex justify-between items-center gap-4">
                    <div className="min-w-0">
                        ...
                        <h1 className="text-xl sm:text-2xl font-black">Manajemen Pendaftaran 📋</h1>
            ...
            <motion.div
                ...
                className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden mb-6">
                <div className="flex items-center gap-3 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100">
                    ...
                    <h2 className="font-bold text-gray-800 text-sm sm:text-base">Filter Pendaftaran</h2>
                </div>
                <div className="p-4 sm:p-6 flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-end flex-wrap">
            ...
            <motion.div
                ...
                <div className="flex items-center gap-3 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100">
                    ...
                    <h2 className="font-bold text-gray-800 text-sm sm:text-base">Daftar Pendaftaran</h2>
                </div>
...
function RegRow({ reg, index, onApprove, onReject }) {
    return (
        <motion.tr variants={fadeUp} className="hover:bg-indigo-50/30 transition-colors duration-150">
            ...
            <td className="px-5 py-4">
                <p className="text-xs text-gray-600 font-medium max-w-[160px] truncate">{reg.event?.title}</p>
            </td>
            <td className="px-5 py-4">
            ...
            <td className="px-5 py-4"><ActionCell reg={reg} onApprove={onApprove} onReject={onReject} /></td>
        </motion.tr>
    );
}
        ...
        <motion.div
            ...
            <div className="flex flex-wrap gap-2 mb-3 text-xs">
                ...
                <span className="flex items-center gap-1 bg-indigo-50 text-indigo-600
                                 px-2 py-0.5 rounded-full border border-indigo-100 font-semibold shrink-0">
            ...
            {reg.status === 'rejected' && reg.rejection_reason && (
                <div className="flex items-start gap-1.5 text-xs text-gray-400 mb-3
                                bg-red-50 rounded-xl px-3 py-2 border border-red-100">
                    <Info className="w-3.5 h-3.5 shrink-0 mt-0.5 text-red-400" />
                    <span className="italic">{reg.rejection_reason}</span>
                </div>
            )}
...
function ActionCell({ reg, onApprove, onReject, mobile }) {
    ...
    if (reg.status === 'rejected' && reg.rejection_reason && !mobile) {
        return (
...
function StatusBadge({ status }) {
    ...
    return (
        <span className={`inline-flex items-center gap-1.5 text-xs font-bold px-2.5 py-1
                          rounded-full shrink-0 ${cfg.bg} ${cfg.text}`}>
